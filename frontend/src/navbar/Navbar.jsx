      ...
      <div className="md:flex items-center justify-between py-4 md:pr-20 lg:pr-40 px-10">
        ...
        <ul className={`md:flex md:items-center  ${menuOpen ? "" : "hidden"}`}>
          ...
          <li>
            {auth.isLoggedIn ? (
              <a
                className="text-light-text hover:text-light-accent dark:text-dark-text dark:hover:text-dark-accent duration-500 md:ml-8 text-xl md:my-1 my-7 cursor-pointer"
                onClick={auth.logout}
              >
                Logout
              </a>
              ...
              <a
                className="text-light-text hover:text-light-accent dark:text-dark-text dark:hover:text-dark-accent duration-500 md:ml-8 text-xl md:my-1 my-7"
                href="/loginpage"
              >
                Login
              </a>
